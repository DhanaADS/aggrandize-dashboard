...
-- Test the function
SELECT 'Testing create_todo_for_user function:' as test;
-- This will only work if you have a valid user in user_profiles
-- SELECT create_todo_for_user('Test Todo via Function', 'Testing RLS bypass', 'high', 'general', 'your-email@example.com');