    ...
    <Box>
      <Box mb={3}>
        ...
        <Typography variant="body2" color="text.secondary">
          Items awaiting marketing team approval
        </Typography>
      </Box>
      ...
      {!loading && !error && tasks.length === 0 && (
        <Paper sx={{ p: 6, textAlign: 'center' }}>
          ...
          <Typography variant="body2" color="text.secondary">
            You don't have any items awaiting approval.
          </Typography>
        </Paper>
      )}
      ...
      {!loading && !error && tasks.length > 0 && (
        <>
          <Alert severity="info" sx={{ mb: 3 }}>
            You have {tasks.length} item{tasks.length > 1 ? 's' : ''} waiting for approval from the marketing team.
          </Alert>
